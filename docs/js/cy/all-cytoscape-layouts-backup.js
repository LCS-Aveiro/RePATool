window.RTA_DEFAULT_LAYOUTS  = 
{
  ...
  "cyLayout_name_AdvancedBot": {
    ...
    "edges": {},
    "weights": {
      "event_Home_Office_go_work_go_work": 0.9,
      "event_Home_Station_go_charge_go_charge": 0.081,
      "event_Office_Office_easy_task_easy_task": 0.6613,
      "event_Home_Home_battery_low_battery_low": 0.009,
      "event_Station_Home_finish_charge_finish_charge": 1,
      "event_Home_Home_socialize_socialize": 0,
      "event_Office_Office_high_stress_high_stress": 0.2365,
      "event_Office_Home_go_home_go_home": 0.1022,
      "event_Home_Home_no_money_no_money": 0.0333
    }
  },
  "cyLayout_name_Like2": {
    "nodes": {
      ...
      "event_WATCH_FEED_dontLike_wdf": {
        "x": 179.98726249210887,
        "y": -116.72821513449416
      },
  ...
  "cyLayout_name_Counter": {
    "nodes": {
      ...
      "event_act_act_offAct_offAct": {
        "x": 133.9987887536086,
        "y": -63.540888456549915
      },
      "event_act_on1_acttauon1_acttauon1": {
        "x": 143.52813166813098,
        "y": 163.30956602234218
      },
      "event_s0_s0_act_act": {
        "x": 109.7,
        "y": 69.55
  ...
  "cyLayout_name_Simple": {
    "nodes": {
      "s0": {
        "x": 27.011864410171974,
        "y": 17.681092536758378
      },
      "event_a_a_offA_offA": {
        "x": 132.43693185151437,
        "y": 12.082567765381741
      },
      "s1": {
        "x": 239.74283683593902,
        "y": 7.538882381486211
      },
      "event_s0_s1_a_a": {
        "x": 132.42971165955154,
        "y": 93.56073143963614
      },
      "event_s1_s0_b_b": {
        "x": 136.62347721928023,
        "y": -74.52800887914707
      }
    },
    "edges": {}
  ...
  "cyLayout_name_Penguim": {
    "nodes": {
      ...
      "event_Son_of_Tweetie_Special_Penguin_ss_ss": {
        "x": 48.61205286269213,
        "y": 53.22762434554974
      },
  ...
  "cyLayout_name_Conditions": {
    "nodes": {
      ...
      "event_middle_endN_activateStep2_activateStep2": {
        "x": 336.62882132285716,
        "y": -117.06020504869277
      },
      "endN": {
        "x": 527.7384615384614,
